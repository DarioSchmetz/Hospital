...
public class AtencionPrimaria extends Hospital {
  ...
  public AtencionPrimaria   (String nombre, String domicilio, String director,int capacidad, boolean tieneLaboratorio , boolean tieneRadiologia, boolean  tieneVacunatorio) {
